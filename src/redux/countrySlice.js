...
//         state.choiseCountries = state.choiseCountries.filter((country) =>
//           country.region.includes(action.payload.regionValue)
//         );
//       }
...
//     builder
//       .addCase(fetchContries.pending, (state) => {
...
//       .addCase(fetchContryByName.pending, (state) => {
//         state.isLoading = true;
//       })
...
//       .addCase(fetchContryBorders.pending, (state) => {
//         state.isLoading = true;
//       })
